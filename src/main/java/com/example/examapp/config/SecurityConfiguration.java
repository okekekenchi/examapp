	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		http.
			authorizeRequests()
				...
				.antMatchers("/vendor/*", "/vendorprofile/*").hasRole("ADMIN")
				...
				.antMatchers("/studentprofile/*").hasAnyRole("ADMIN", "USER")
				.antMatchers("/disablederrorpage/*").permitAll()
				
				/**
				 * REST APIs
				 */
				.antMatchers("/authenticate", "/examquestion/*", "/questionproperty/*", "/saveResult").permitAll()

				.anyRequest().authenticated()
				.and()
				.csrf().ignoringAntMatchers("/authenticate","/questionproperty/*", "/examquestion/*", "/saveResult")
				.and()
				.formLogin()
					.loginPage("/login")
